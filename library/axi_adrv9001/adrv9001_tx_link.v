...
module adrv9001_tx_link  #(
  ...
  reg [3:0] data2_4 = 4'b0;
  reg [3:0] data2_5 = 4'b0;
  reg [3:0] data2_6 = 4'b0;
  reg [3:0] data2_7 = 4'b0;
  ...
  always @(posedge tx_clk) begin
	...
	data2_4 <= tx_data_q[3:0];
	data2_5 <= tx_data_q[7:4];
	data2_6 <= tx_data_q[11:8];
	data2_7 <= tx_data_q[15:12];
	strobe2 <= {1'b1, 3'b0};
     end else if (ld_next) begin
	...
	data2_4 <= {data2_4,2'b0};
        data2_5 <= {data2_5,2'b0};
        data2_6 <= {data2_6,2'b0};
        data2_7 <= {data2_7,2'b0};
  ...
  assign dac_data_0 = tx_single_lane ? (tx_symb_b1 ? (tx_symb_b2 ? data16_0 : {data8_0,data8_1}) : (tx_symb_b2 ? {data2_0,data2_1,data2_2,data2_3} :
  ...
  assign dac_data_3 = tx_single_lane ? 'b0 :
                           ...
                           1'b0);
  assign dac_data_strobe = tx_single_lane ? (tx_symb_b1 ? (tx_symb_b2 ? strobe16 : strobe8) : (tx_symb_b2 ? strobe2 :
