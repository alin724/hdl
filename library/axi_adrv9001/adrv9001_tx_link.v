...
module adrv9001_tx_link  #(
  ...
  input          tx_symb_mode[1:0]                 //bit 2 of symbol op mode }    0  0               0  1            1   0        1  1
  ...
  always @(posedge tx_clk) begin
	...
	if(!(tx_symb_mode[1] | tx_symb_mode[0])) begin
  ...
  assign dac_data_0 = tx_single_lane ? ((tx_symb_mode[1] | tx_symb_mode[0]) ? (tx_sdr_ddr_n ? data16sdr_0 : data16_0[15-:8]):
  ...
  assign dac_data_strobe = tx_single_lane ? (tx_symb_mode[1] ? (tx_symb_mode[0] ? (tx_sdr_ddr_n ? strobe16sdr : strobe16[15-:8]) : (tx_sdr_ddr_n ? strobe8sdr : strobe8)) : (tx_symb_mode[0] ? (tx_sdr_ddr_n ? strobe2sdr :strobe2 ):
