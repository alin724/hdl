...
module adrv9001_tx_link  #(
  ...
  assign dac_data_0 = tx_single_lane ? (tx_symb_2_8_16b[0] ? (tx_symb_2_8_16b[1] ? data16_0 : {data8_0,data8_1}) : (tx_symb_2_8_16b[1] ? {data2_0,data2_1,data2_2,data2_3} :
  ...
  assign dac_data_3 = tx_single_lane ? 'b0 :
                           ...
                           1'b0);
  assign dac_data_strobe = tx_single_lane ? (tx_symb_2_8_16b[0] ? (tx_symb_2_8_16b[1] ? strobe16 : {strobe8,strobe8}) : (tx_symb_2_8_16b[1] ? {strobe2,strobe2,strobe2,strobe2} :
