...
module axi_ad9001_core #(
  ...
  sync_bits #(
    ...
    .ASYNC_CLK (1))
  i_tx1_ctrl_sync (
    .in_bits ({up_tx1_r1_mode,tx1_symb_mode,tx1_sdr_ddr_n,tx1_single_lane,tx1_rst}),
    .out_clk (tx2_clk),
    .out_resetn (1'b1),
    .out_bits ({tx1_r1_mode,tx1_symb_mode_s,tx1_sdr_ddr_n_s,tx1_single_lane_s,tx1_rst_s}));
  ...
  assign tx2_symb_mode = tx1_r1_mode ? tx2_symb_mode_loc : tx1_symb_mode_s;
  ...
  i_tx2 (
    ...
    .dac_symb_mode (tx2_symb_mode_loc),
    .dac_sync_in (1'b0),
    .dac_sync_out (),
