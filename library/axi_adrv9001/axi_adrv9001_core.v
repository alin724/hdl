...
module axi_ad9001_core #(
  ...
  sync_bits #(
    ...
    .ASYNC_CLK (1))
  i_tx1_ctrl_sync (
    .in_bits ({up_tx1_r1_mode,tx1_symb_2_8_16b,tx1_symb_b2,tx1_sdr_ddr_n,tx1_single_lane,tx1_rst}),
    .out_clk (tx2_clk),
    .out_resetn (1'b1),
    .out_bits ({tx1_r1_mode,tx1_symb_2_8_16b_s,tx1_symb_b2_s,tx1_sdr_ddr_n_s,tx1_single_lane_s,tx1_rst_s}));
  ...
  assign tx2_symb_2_8_16b = tx1_r1_mode ? tx2_symb_2_8_16b_loc : tx1_symb_2_8_16b_s;
  ...
  i_tx1 (
    ...
    .dac_symb_2_8_16b (tx1_symb_2_8_16b),
  ...
  i_tx2 (
    ...
    .dac_symb_2_8_16b (tx2_symb_2_8_16b_loc),
    .dac_sync_in (1'b0),
    .dac_sync_out (),
