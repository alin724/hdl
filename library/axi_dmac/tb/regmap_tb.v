...
module regmap_tb;
  ...
  begin
    ...
    set_reset_reg_value('h10, 32'h00002101); /*	INTERFACE_DESCRIPTION */
    set_reset_reg_value('h80, 'h3); /* IRQ mask */

    set_reset_reg_value('h40c, 'h7); /* Flags */
  ...
  initial begin
    ...
    set_reset_reg_value('h44c, 'h0);
    set_reset_reg_value('h450, 'h0);
    set_reset_reg_value('h428, 'h0);
    set_reset_reg_value('h448, 24'h000080);
    set_reset_reg_value('h44c, 32'h00000080);
