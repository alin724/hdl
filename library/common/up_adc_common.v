...
module up_adc_common #(
  ...
  reg                 up_adc_symb_b1 = 'd0;
  reg                 up_adc_symb_b2 = 'd0;
  ...
  always @(posedge up_clk) begin
	...
	up_adc_symb_b1 <= up_wdata[15];
	up_adc_symb_b2 <= up_wdata[14];
  ...
  up_xfer_cntrl #(.DATA_WIDTH(47)) i_xfer_cntrl (
    .up_rstn (up_rstn),
    .up_clk (up_clk),
