...
module up_dac_common #(
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      up_dac_num_lanes <= 'd0;
      up_dac_sdr_ddr_n <= 'd0;
      up_dac_symb_mode[1] <= 'd0;
      up_dac_symb_mode[0] <= 'd0;
      up_dac_par_type <= 'd0;
      up_dac_par_enb <= 'd0;
      up_dac_r1_mode <= 'd0;
      up_dac_datafmt <= 'd0;
	  ...
	  up_dac_symb_mode[1] <= up_wdata[15];
	  up_dac_symb_mode[0] <= up_wdata[14];
      ...
      if (up_rreq_s == 1'b1) begin
        case (up_raddr[6:0])
          ...
          7'h12: up_rdata_int <= {15'd0, up_dac_sdr_ddr_n,
		                  up_dac_symb_mode[1],up_dac_symb_mode[0],
